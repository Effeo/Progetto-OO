	...
	public MyUtente(JFrame home, Utente utente, Controller controller, boolean flag) {
		...
		btnConferma.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				esito=controller.updateUtente(NikName.getSelectedText(),Nome.getSelectedText(),Cognome.getSelectedText(),Nazione.getSelectedText(),(String) list.getSelectedValue(),chckbxPremium.isSelected(),chckbxAdmin.isSelected());
				if(esito == 1 ) {System.out.println("Update avvenuto con successo");}
				else {System.out.println("Update Fallito");}
			}
		});
