...
public class UtenteImplementazioneDao implements UtenteDAO{
	...
	public int updateUtente(String nickanme,String nome, String cognome, String nazione,String sesso,boolean IsPremium, boolean IsAdmin)
	{
		int esito=0;
		
		try
		{
			PreparedStatement queryupdateUtente= connection.prepareStatement("UPDATE UTENTE SET NOme= '"+nome+"' , Cognome= '" +cognome+"', Nazione= '"+nazione+"',Sesso= '"+sesso+"' , IsPremium="+IsPremium+",IsAdmin="+IsAdmin+"WHERE Nickname= '"+nickanme+"' ;");
